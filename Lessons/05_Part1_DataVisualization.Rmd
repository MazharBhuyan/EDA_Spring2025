...
# Scatterplot
# bothe the following code generate same plot but aes apply globally. If another layer is added the second series will also consider x= Date and y=Ozone
...
O3plot2 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone, color = "blue"))
print(O3plot2)
# adding color inside aes is another layer. it considers blue as another layer. 
...
PMplot <- 
  ...
  geom_point()
print(PMplot) #not giving much information.
